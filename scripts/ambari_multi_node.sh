...
docker run --network=exam_bridge --ip=172.18.0.2 --privileged=true -d --dns 8.8.8.8 -p 8080:8080 -p 8440:8440 -p 8441:8441 -p 50070:50070 -p 8020:8020 -e AMBARI_SERVER=node1  --name node1 -h node1 -i -t hwxu/ambari_2.2_server_node
...
docker run --network=exam_bridge --ip=172.18.0.4 --privileged=true -d --link node1:node1 -e namenode_ip=$IP_namenode --dns 8.8.8.8 -p 11000:11000 -p 2181 -p 50111:50111 -p 9083 -p 10000 -p 9999:9999 -p 9933:9933 -p 22 -p 8440 -p 8441 --name node3 -h node3 -i -t hwxu/ambari_2.2_agent_node
...
docker run --network=exam_bridge --ip=172.18.0.5 --privileged=true -d --dns 8.8.8.8 -h node4 --name node4 -p 22 --link node1:node1 -p 8440 -p 8441 -i -t hwxu/ambari_2.2_agent_node
...
docker run --network=exam_bridge --ip=172.18.0.6 --privileged=true -d --dns 8.8.8.8 -h node5 --name node5 -p 22 --link node1:node1 -p 8440 -p 8441 -i -t hwxu/ambari_2.2_agent_node
